...
const Button = forwardRef(({ 
  ...
  const variants = {
    primary: "bg-gradient-to-r from-primary to-orange-500 text-white hover:from-orange-600 hover:to-orange-700 focus:ring-primary shadow-lg hover:shadow-xl transform hover:scale-105",
